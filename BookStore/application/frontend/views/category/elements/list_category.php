...
if (!empty($this->category)) {
    foreach ($this->category as $item) {
        ...
        $dataUrl = URL::createLink($this->arrParam['module'], $this->arrParam['controller'], 'quickViewCategory', ['category_id' => 'value_new']);
        @$xhtmlListCategory .= '
            ...
            <div class="product-box">
                <div class="img-wrapper">
                    ...
                    <div class="cart-info cart-wrap">
                        ...
                        <a href="#" title="Quick View"><i class="ti-search category-show" data-id="' . $item['id'] . '" data-url="'.$dataUrl.'" data-toggle="modal" data-target="#quick-view"></i></a>
                    </div>
                </div>
